...
function follow_click(){
  ...
  else if(document.getElementById("followBtn").innerText == "Following"){
  ...
  trackIndex = 0;
  // <!-- <td><img style="height: 33px; width: 33px" [src]="'http://localhost:8001/' +song.picture" alt=""></td>
  //             <td><a [href]="'http://localhost:8001/'+song.song_name">Play</a></td> -->
  
  tracks = [
    "'http://localhost:8001/' + songobj[0].song_name"
  ...
  thumbnails = [
    "'http://localhost:8001/' + songobj[0].picture"
  ...
  trackArtists = [songobj[0].artistid];
  trackTitles = [songobj[0].nameofthesong];
